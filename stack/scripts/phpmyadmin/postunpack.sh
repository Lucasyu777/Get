...
# Grant ownership for the default "bitnami" SSH user to edit files
info "Granting write privileges to phpMyAdmin directories for the 'bitnami' user"
configure_permissions_ownership "$PHPMYADMIN_BASE_DIR" -u "bitnami" -g "$WEB_SERVER_DAEMON_USER"
