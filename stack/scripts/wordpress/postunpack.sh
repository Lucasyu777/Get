...
# WordPress requires write privileges to the entire htdocs directory because of its auto-updater
configure_permissions_ownership "$WORDPRESS_BASE_DIR" -u "bitnami" -g "$WEB_SERVER_DAEMON_USER" -d 775 -f 664
