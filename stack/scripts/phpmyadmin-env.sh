...
export PHPMYADMIN_DEFAULT_ALLOW_REMOTE_CONNECTIONS="no" # only used at build time
...
export PHPMYADMIN_DEFAULT_URL_PREFIX="/phpmyadmin" # only used at build time
export PHPMYADMIN_URL_PREFIX="${PHPMYADMIN_URL_PREFIX:-$PHPMYADMIN_DEFAULT_URL_PREFIX}"
...
export DATABASE_DEFAULT_HOST="127.0.0.1" # only used at build time
export DATABASE_HOST="${DATABASE_HOST:-}"
export DATABASE_DEFAULT_PORT_NUMBER="3306" # only used at build time
export DATABASE_PORT_NUMBER="${DATABASE_PORT_NUMBER:-}"
export DATABASE_DEFAULT_ALLOW_NO_PASSWORD="no" # only used at build time
