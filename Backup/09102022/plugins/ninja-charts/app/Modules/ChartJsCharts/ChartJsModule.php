...
namespace NinjaCharts\Modules\ChartJsCharts;

use NinjaCharts\Traits\ChartGenerator;
use NinjaCharts\Framework\Support\Arr;
use NinjaCharts\Modules\NinjaTables\CalculativeModule as NinjaTableCalculative;
use NinjaCharts\Traits\ChartDesignHelper;
use NinjaCharts\Modules\FluentForms\CalculativeModule as FluentFormCalculative;
use NinjaCharts\Modules\FluentForms\Module;
...
class ChartJsModule
{
    ...
    public function ninjaTableDataFormat($data, $extra_data)
    {
        ...
        $chart_data = $this->commonChartRender($data, $extra_data, $c_labels, $chart_data);
    ...
    public function commonChartRender($data, $extra_data, $c_labels, $chart_data)
    {
        extract($data);
        if ($chart_type === 'bubble' || $chart_type === 'scatter') {
