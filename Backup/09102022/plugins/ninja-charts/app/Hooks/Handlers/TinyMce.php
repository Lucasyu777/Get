...
{   
    ...
    {
        $plugin_array['ninja_charts'] = NINJA_CHARTS_URL . 'assets/admin/js/ninja-charts-tinymce-button.js';
        return $plugin_array;
    }
    ...
    public function pushNinjaChartsToEditorFooter()
    {
        ...
        <script type="text/javascript">
            window.ninja_charts_tiny_mce = {
                ...
                logo: <?php echo json_encode(NINJA_CHARTS_URL . 'assets/admin/img/icon_small.png');?>
            }
        </script>
        <?php
    }
    ...
    public function gutenBlockLoad()
    {
        add_action('enqueue_block_editor_assets', function () {
            wp_enqueue_script(
                ...
                NINJA_CHARTS_URL . 'assets/admin/js/ninja-charts-gutenblock-build.js',
                array('wp-blocks', 'wp-i18n', 'wp-element', 'wp-components', 'wp-editor')
            );

            wp_enqueue_style(
                'ninja-charts-gutenberg-block',
                NINJA_CHARTS_URL . 'assets/admin/css/gutenblock.css',
